...
// RegisterRESTRoutes registers the marketplace module's REST service handlers.
...
// Route returns the marketplace module's message routing key.
...
// LegacyQuerierHandler returns the marketplace module's Querier.
